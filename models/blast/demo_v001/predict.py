...
def predict(input: dict) -> ModelResult:
    try:
        ...
        b = s["blast"]
        return ModelResult(
            model_id="blast", model_version="demo_v001", status="DEMO",
            data_source="SYNTHETIC_SCENARIO",
            prediction={"delay_risk": b["delay_risk"]},
        )
    except Exception as e:
        return ModelResult(model_id="blast", model_version="demo_v001", status="UNAVAILABLE",
